...
(* ::Input::Initialization:: *)
backepimut=E^RandomVariate[UniformDistribution[{Log[0.00001],Log[0.5]}],300]
...
(* ::Input::Initialization:: *)
Export["model_FullParamSpace_Scenario1.txt",finaltable,"Table"]
...
(* ::Input::Initialization:: *)
Export["model_FullParamSpace_Scenario2.txt",finaltable,"Table"]
...
(* ::Input::Initialization:: *)
Export["model_FullParamSpace_Scenario3.txt",finaltable,"Table"]
...
(* ::Input::Initialization:: *)
Clear[p1, p2, p3, p4, q1, q2, q3, w11, w22, w33, w44, w12, w13, w14, w23, w24, w34, t,t1, t2, t3, sumofp, results, jacobian1, jacobian2, jacobian3, jacobian4, jacobian5, jacobian6,detjacobian1, detjacobian2, detjacobian3,detjacobian4, detjacobian5, detjacobian6,scenario]
...
equil3={Part[listp1,3],Part[listp2,3],Part[listp3,3]};
	q1:=Part[equil3,1]; q2:=Part[equil3,2]; q3:=Part[equil3,3];
	 jacobian3=Eigenvalues[jacobian];detjacobian3=Det[jacobian];

If[FromDigits[Dimensions[results,1]]>3,
equil4={Part[listp1,4],Part[listp2,4],Part[listp3,4]};
	q1:=Part[equil4,1]; q2:=Part[equil4,2]; q3:=Part[equil4,3];
	 jacobian4=Eigenvalues[jacobian];detjacobian4=Det[jacobian];

If[FromDigits[Dimensions[results,1]]>4,
equil5={Part[listp1,5],Part[listp2,5],Part[listp3,5]};
	q1:=Part[equil5,1]; q2:=Part[equil5,2]; q3:=Part[equil5,3];
	 jacobian5=Eigenvalues[jacobian];detjacobian5=Det[jacobian];

If[FromDigits[Dimensions[results,1]]>5,
equil6={Part[listp1,6],Part[listp2,6],Part[listp3,6]};
	q1:=Part[equil6,1]; q2:=Part[equil6,2]; q3:=Part[equil6,3];
	 jacobian6=Eigenvalues[jacobian];detjacobian6=Det[jacobian];
AppendTo[finaltable,{t1,t2,t3,w11,w22,w33,w44,w12,w13,w14,w23,w24,w34,FromDigits[Dimensions[results,1]],equil1,jacobian1,detjacobian1,equil2,jacobian2,detjacobian2,equil3,jacobian3,detjacobian3,equil4,jacobian4,detjacobian4,equil5,jacobian5,detjacobian5,equil6,jacobian6,detjacobian6}],
AppendTo[finaltable,{t1,t2,t3,w11,w22,w33,w44,w12,w13,w14,w23,w24,w34,FromDigits[Dimensions[results,1]],equil1,jacobian1,detjacobian1,equil2,jacobian2,detjacobian2,equil3,jacobian3,detjacobian3,equil4,jacobian4,detjacobian4,equil5,jacobian5,detjacobian5}]],
AppendTo[finaltable,{t1,t2,t3,w11,w22,w33,w44,w12,w13,w14,w23,w24,w34,FromDigits[Dimensions[results,1]],equil1,jacobian1,detjacobian1,equil2,jacobian2,detjacobian2,equil3,jacobian3,detjacobian3,equil4,jacobian4,detjacobian4}]],
AppendTo[finaltable,{t1,t2,t3,w11,w22,w33,w44,w12,w13,w14,w23,w24,w34,FromDigits[Dimensions[results,1]],equil1,jacobian1,detjacobian1,equil2,jacobian2,detjacobian2,equil3,jacobian3,detjacobian3}]],AppendTo[finaltable,{t1,t2,t3,w11,w22,w33,w44,w12,w13,w14,w23,w24,w34,FromDigits[Dimensions[results,1]],equil1,jacobian1,detjacobian1,equil2,jacobian2,detjacobian2}]],
AppendTo[finaltable,{t1,t2,t3,w11,w22,w33,w44,w12,w13,w14,w23,w24,w34,FromDigits[Dimensions[results,1]],equil1,jacobian1,detjacobian1}]]]]
...
(* ::Input::Initialization:: *)
Export["model_FullParamSpace_Scenario4.txt",finaltable,"Table"]


(* ::Subsubsection:: *)
(*Scenario 0a - no fitness differences*)
...
(* ::Input::Initialization:: *)
Export["model_FullParamSpace_Scenario0.txt",finaltable,"Table"]
