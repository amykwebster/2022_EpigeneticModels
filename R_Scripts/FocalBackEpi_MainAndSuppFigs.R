#This script produces the graphs for the focal back-epimutation rates found in the main figures, as well as all supplemental figures
#It requires two csv files: 1) model_FocalBackEpi_AllScenarios.csv and 2) model_FocalBackEpi_AllScenarios_Symmetric.csv
#The first csv is used to generate the main figures, while the second is used to check the results when the symmetric analysis is performed
